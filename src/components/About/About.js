...
const style = {
  ...
  container: `flex flex-col rounded-xl bg-stone-900/50 items-center mx-8 pt-8 mt-20 shadow-xl border border-stone-900`,
  about: `p-4 m-2 text-lg md:text-2xl border border-stone-800/50 text-slate-100 rounded-lg bg-slate-800/75 md:m-40 font-bold tracking-wide leading-relaxed text-center text-slate-300`,
};
