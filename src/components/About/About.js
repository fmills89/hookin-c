...
const style = {
  ...
  about: `p-4 m-2 text-lg md:text-2xl border border-stone-900 text-slate-100 rounded-lg bg-slate-800 md:m-40 font-bold tracking-wide leading-relaxed text-center text-gray-300 opacity-75`,
};
